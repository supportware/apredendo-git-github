...
<?php
  ...
  else
  {
      ...
      $linhas = listar_tabela_ingrediente();     # Captura todas as linhas da tabela
      ...
      echo "<script language=javascript>window.location.replace('../../stock/remover_ingrediente.php');</script>";
